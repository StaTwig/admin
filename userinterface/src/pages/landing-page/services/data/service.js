const service = [
    {
        id:"1",
        image: require("../../../../assests/files/images/services/s1.png"),
    ...
    {
        id:"2",
        image:require("../../../../assests/files/images/services/s2.png"),
    ...
    {
        id:"3",
        image:require("../../../../assests/files/images/services/s3.png"),
    ...
    {
        id:"4",
        image:require("../../../../assests/files/images/services/s4.png"),
    ...
    {
        id:"5",
        image:require("../../../../assests/files/images/services/s5.png"),
        title:"Real Time Shipment updates and Order Management",
        content:"Be it order management, inventory management or receiving real-time shipment updates, you don’t need to maintain different sets of applications when you can accomplish all of them in a single platform",
    },
    {
        id:"6",
        image:require("../../../../assests/files/images/services/s6.png"),
        title:"GS1 Compliant",
