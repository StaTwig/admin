...
exports.trackStats = [
  (req, res) => {
    try {
      ...
      return apiResponse.successResponseWithData(res, "Data sent", overviewObject);
    } catch (err) {
...
exports.fetchTransactions = [
  (req, res) => {
    try {
      ...
      return apiResponse.successResponseWithData(res, "Transactions Sent", transactionObject)
    } catch (err) {
      return apiResponse.ErrorResponse(res, err);
    }
  }
...
exports.fetchShipmentDetails = [
    (req,res) => {
        try{
            ...
            return apiResponse.successResponseWithData(res, "Data sent", shipmentObject);
        }
        catch (err) {
            return apiResponse.ErrorResponse(res, err)
        }
...
exports.fetchLocation = [
    (req,res) => {
        try{
            ...
            return apiResponse.successResponseWithData(res, "Data sent", locationObject);
        }
        catch (err) {
            return apiResponse.ErrorResponse(res, err)
        }
...
exports.fetchTemperature = [
    (req,res) => {
        try{
            ...
            return apiResponse.successResponseWithData(res, "Data sent", temperatureObject);
        }
        catch (err) {
            return apiResponse.ErrorResponse(res, err)
        }
...
exports.fetchTracking = [
    (req,res) => {
        try{
            ...
            return apiResponse.successResponseWithData(res, "Data sent", trackingObject);
        }
        catch (err) {
            return apiResponse.ErrorResponse(res, err)
        }
