...
const RbacSchema = new mongoose.Schema(
  {
    ...
    shipment: {
      ...
      shipmentReference: { type: Boolean, default: false },
      shipmentTemperture: { type: Boolean, default: false },
      shipmentTripscore: { type: Boolean, default: false },
      shipmentMap: { type: Boolean, default: false },
    },
    order: {
