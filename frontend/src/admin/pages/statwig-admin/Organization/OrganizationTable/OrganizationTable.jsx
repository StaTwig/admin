      ...
      >
        <TableHead className="organization-thead">
          <TableRow className="organization-tr">
            ...
            <TableCell>
              <h1 className="vl-note f-500 vl-royal">Organization Name</h1>
            </TableCell>
            <TableCell>
              <h1 className="vl-note f-500 vl-royal">Organization Type</h1>
            </TableCell>
            <TableCell>
              <h1 className="vl-note f-500 vl-royal">Total Users</h1>
            </TableCell>
            <TableCell>
              <h1 className="vl-note f-500 vl-royal">All Locations</h1>
            </TableCell>
            <TableCell>
              <h1 className="vl-note f-500 vl-royal">Country</h1>
            </TableCell>
            <TableCell>
