...
const AccordionSummary = styled((props) => <MuiAccordionSummary key={props.key} {...props} />)(
	({ theme }) => ({
...
export default function Roles({ list, permissionType, permissions, refresh, flag, updatePermissions }) {
