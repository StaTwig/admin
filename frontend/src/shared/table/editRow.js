			...
			<div className="d-flex flex-column ml-5 itable">
              ...
              /> */}
							<Select
								...
								value={
									categories === "Select Category" ? null : { value: categories, label: categories }
								}
							...
							<div className="d-flex pt-1 flex-row justify-content-between">
								...
								>
									<Select
										...
										// defaultInputValue={inventories.type}
										onChange={(item) => handleInventoryChange(idx, "productName", item.name)}
						...
						>
							<div className="">
								<input
									...
									value={batchNumber}
									onChange={(e) => handleInventoryChange(idx, "batchNumber", e.target.value)}
								/>
							</div>
						</div>
						<div className="col mt-1 mb-1">
							<div style={{ position: "relative", right: "13px" }}>
								<input
									...
									value={quantity}
									onChange={(e) => handleInventoryChange(idx, "quantity", e.target.value)}
								/>
							</div>
						</div>
						<div
					...
					{inventories.length > 1 && (
						<div className="m-2 pl-3 pt-1" style={{ position: "relative", left: "10px" }}>
							...
							>
								<img className="cursorP p-1" height="30" src={Delete} alt="Delete" />
							</span>
						</div>
					)}
					{!addMore && (
					...
					<div className="rTable row col-12">
						<div className="row col-12 mb-2">
							<div className="col theader text-center pro mfg-add-inventory">
								<img src={sdate} width="16" height="16" alt="ManufacturedDate" />
							...
							<div className="col mt-1 mb-1 ">
								<div className="">
									<input
										...
										value={serialNumber}
										onChange={(e) => handleInventoryChange(idx, "serialNumber", e.target.value)}
									/>
								</div>
							</div>
						</div>
