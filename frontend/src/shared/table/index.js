								...
								>
									{inventory.eventTypePrimary !== "ADD" ? (
										inventory.eventTypePrimary === "RECEIVE" ? (
											<div className="custom-status secondary-bg bg-success"> {t("received")}</div>
										) : inventory.eventTypePrimary !== "BUY" ? (
											<div className="custom-status secondary-bg bg-warning">{t("sent")}</div>
										) : (
											<div className="custom-status secondary-bg bg-warning">{t("sold")}</div>
										)
									) : (
										<div className="custom-status secondary-bg bg-primary">{t("added")}</div>
									)}
								</div>
								<div className=" rTableCell m-1" style={{ position: "relative", left: "7.5%" }}>
									<span className="drop-pad rounded-circle ">
										<img src={dropdownIcon} height="8" width="14" alt="DropDownIcon" />{" "}
									</span>
								</div>
								{/* <button
												...
												inventory.eventTypePrimary === "RECEIVE" ? (
													<div>
														<TableRow>
															...
															<div>
																<TableCell align="left">{inventory.shipmentDetails.id}</TableCell>
															</div>
														</TableRow>
														<TableRow>
															<TableCell>
													...
													<div>
														<TableRow>
															...
															<div className="ml-5">
																<TableCell align="left">
																	{formatDate(inventory.payloadData.data.products.mfgDate)}
																</TableCell>
															</div>
														</TableRow>
														<TableRow>
															...
															<div className="ml-5">
																<TableCell align="left">
																	{formatDate(inventory.payloadData.data.products.expDate)}
																</TableCell>
															</div>
														</TableRow>
														<TableRow>
