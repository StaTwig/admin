  ...
  return (
    <div className='mobilemenu'>
      ...
      <ul>
        ...
        <li
          className={
            url === "/shipments" || url === "/newshipment" ? "active" : ""
          }
        >
          <Link to='/shipments'>
            <img
              src={
                url === "/shipments" || url === "/newshipment"
                  ? shipSelectedIcon
                  : shipIcon
              }
              alt='Shippment'
        ...
        <li
          className={
            url === "/inventory" || url === "/newinventory" ? "active" : ""
          }
        >
          <Link to='/inventory'>
            <img
              src={
                url === "/inventory" || url === "/newinventory"
        ...
        <li className={url === "/network" ? "active" : ""}>
          <Link to='/network'>
            <img
              src={url === "/network" ? NetworkSelectedIcon : NetworkIcon}
              alt='Network'
            />
            <span>Network</span>
          </Link>
