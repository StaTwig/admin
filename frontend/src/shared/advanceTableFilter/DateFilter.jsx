        ...
        <>
            ...
            <div className="valueDisplay">
                <div className="groupFlex fromData">
                    ...
                    <input type="text" value={fweek[0] ? new Date(fweek[0]) : ""} placeholder='DD/MM/YYYY' />
                </div>
                {DateType === 2 && (<div className="groupFlex toData">
                <label htmlFor="to">{t("to")}</label>
                    <input type="text" value={fweek[1] ? new Date(fweek[1]) : ""} placeholder='DD/MM/YYYY' />
                </div>)}
            </div>
            <Calendar
                value={fweek}
                range={DateType === 2 ? true : false }
                onChange={(e) => { setFweek(e); onSelectionDateFilter(e);}}
            />
            <div className="valueDisplay">
                <button
                style={{
