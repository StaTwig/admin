				...
				<ul className="product-details-list">
					<li className="product-list-card">
						<div className="mi-flex-ac gap-1">
							...
							<p className="mi-body-sm f-500 mi-reset grey">{t("product_name")}</p>
						</div>
					...
					<li className="product-list-card">
						<div className="mi-flex-ac gap-1">
							...
							<p className="mi-body-sm f-500 mi-reset grey">{t("manufacturer")}</p>
						</div>
					...
					<li className="product-list-card">
						<div className="mi-flex-ac gap-1">
							...
							<p className="mi-body-sm f-500 mi-reset grey">{t("batch")}</p>
						</div>
					...
					<li className="product-list-card">
						<div className="mi-flex-ac gap-1">
							...
							<p className="mi-body-sm f-500 mi-reset grey">{t("label")}</p>
						</div>
					...
					<li className="product-list-card">
						<div className="mi-flex-ac gap-1">
							<i className="fa-solid fa-tag color-green"></i>
							<p className="mi-body-sm f-500 mi-reset grey">{t("quantity")}</p>
						</div>
						<p className="mi-body-sm f-500 mi-reset color-blue">{`${warehouse?.productQuantity} (${warehouse?.productInfo?.unitofMeasure?.name})`}</p>
					</li>
				</ul>
				...
				<div className="product-date-details">
					<div className="date-container">
						...
						<p className="mi-body-xs f-500 mi-reset white">
							{formatDate(warehouse?.productAttributes?.mfgDate)}
						</p>
					</div>
					<div className="date-container">
						<div className="date-header mi-flex-ac gap-1">
						...
						<p className="mi-body-xs f-500 mi-reset white">
							{formatDate(warehouse?.productAttributes?.expDate)}
						</p>
					</div>
				</div>
			</div>
