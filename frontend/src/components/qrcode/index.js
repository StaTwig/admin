            ...
            <div className='d-flex flex-column'>
              ...
              <div className='d-flex flex-row mb-5'>
                <div
                  className={
                    barvisible
                      ? "panel barcodecommon barcodehighlight mr-4"
                      : "panel barcodecommon barcode mr-4"
                  }
                  onClick={() => {
                ...
                <div
                  className={
                    qrvisible
                      ? "panel barcodecommon qrhighlight"
                      : "panel barcodecommon qr"
                  }
                  onClick={() => {
              ...
              <div className='d-flex flex-row mb-5'>
                <button
                  className={
                    jpgvisible
                      ? "btn btn-orange mr-4 downloadc downloadhi"
                      : "btn btn-orange mr-4 downloadc"
                  }
                  onClick={() => setJpgVisible(!jpgvisible)}
                >
                  <img
                    src={jpgvisible ? DownloadOrange : Download}
                    width='14'
                    height='14'
                    className='mr-2'
                    alt='JPG'
                ...
                <button
                  className={
                    pdfvisible
                      ? "btn btn-yellow downloadc pdhi"
                      : "btn btn-yellow downloadc"
                  }
                  onClick={() => setPdfVisible(!pdfvisible)}
                >
                  <img
                    src={pdfvisible ? DownloadYellow : Download}
                    width='14'
                    height='14'
                    className='mr-2'
                    alt='PDF'
              ...
              <div>
                <button className='btn btn-main-blue' onClick={onDownload}>
                  GENERATE CODE
                </button>
              </div>
            </div>
