...
const PoDetails = (props) => {
  return Object.keys(props.shipments).length === 0 ||
    !props.shipments.poDetails ? (
    <div className='row panel'>N/A</div>
  ) : (
      ...
      <div className='ml-2 mt-2'>
        ...
        <div className='d-flex flex-row potext mb-4'>
          ...
          <div className='d-flex flex-column'>
            <div className='mb-3'>
              {props.shipments.poDetails[0].supplier.supplierOrganisation}
            </div>
        ...
        <div className='d-flex flex-row potext mb-4'>
          ...
          <div className='d-flex flex-column'>
            <div className='mb-3'>
              {props.shipments.poDetails[0].customer.customerOrganisation}
            </div>
        ...
        <table>
          <thead>
            <tr>
              <th scope='col' className=' potexttable text-secondary'>
                Product ID
              </th>
              <th scope='col ' className=' potexttable text-secondary'>
                Product Name
          ...
          <tbody>
            {props.shipments.poDetails[0].products.map((product) => (
              <tr>
        ...
        <div className='d-flex justify-content-end mt-2'>
          <div className='d-flex flex-column'>
            <div className=' potext text-secondary mb-2 mt-1'>
              Total Quantity
            </div>
            <div className='text-info font-weight-bold'>
              {props.shipments.poDetails[0].products[0].productQuantity}
            </div>
          </div>
        </div>
