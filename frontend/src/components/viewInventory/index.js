      ...
      <div className="row">
        ...
        <div className="w-100 pt-5 mt-2">
          {inventories.map((inv, i) => 
            <>
              <div key={i} className="col-12 p-2 mb-3 rounded row bg-white shadow">
                ...
                {more[i]  ?
                  <div className="col-0 txt">
                  <button type="button" onClick={() => toggleShowMore(inv.id, inv.products.id, i, more[i])} className="btn btn-primary">Show {more[i] ? `less` : `more`}</button>
                  </div>
                :
                  <div className="col-0 txt">
                  <button type="button" onClick={() => toggleShowMore(inv.id, inv.products.id, i, more[i])} className="btn btn-outline-primary">Show {more[i] ? `less` : `more`}</button>
                  </div>
                }
               </div>
              </div>
                ...
                <div className="row">
                  <div className="p-2 mt-4 full-width-ribbon">
                    <div className="row filter">
                      ...
                      <div className="col">
                        <img src={Batch} width="16" height="16" alt="Batch Number" />
                        <span className="ml-2 font-small">Batch Number</span>
                      </div>
                      <div className="col pl-0">
                        <img src={calender} width="25" height="16" alt="Mfg Date" />
                        <span className="ml-1 font-small">Mfg Date</span>
                      </div>
                      <div className="col p-0">
                        <img src={calender} width="25" height="16" alt="Exp Date" />
