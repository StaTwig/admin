        ...
        <div className="overflow">
          ...
          {props.inventories.map(inventory => (
            <div className="rTableRow">
              ...
              <div className="rTableCell ml-5">20/12/2017</div>
            <div className="rTableCell ml-5">{inventory.manufacturingDate.length >7  ? `0${new Date(Date.parse(inventory.manufacturingDate)).getMonth()+1}`.slice(-2)+"/"+new Date(Date.parse(inventory.manufacturingDate)).getFullYear() : inventory.manufacturingDate}</div>
