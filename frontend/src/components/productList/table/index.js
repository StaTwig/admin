      ...
      <div className="rTable">
        <div className="overflow">
          {props.inventories.map((inventory,index) => (
            ...
            <div className="rTableCell ml-5">{inventory.manufacturingDate.length>11?inventory.manufacturingDate.substring(5,7)+"/"+inventory.manufacturingDate.substring(0,4):inventory.manufacturingDate.split('/')[1]+"/"+inventory.manufacturingDate.split('/')[2]}</div>
