			...
			<div className="d-flex flex-row justify-content-between">
				<div className="flex-column">
					...
					<div className="text-info pl-3">
						{t("add")} {t("organisation").toLocaleLowerCase()} {t("details")} {t("to")}{" "}
						{t("continue").toLocaleLowerCase()}
					</div>
				</div>
				<div>
										...
										<div className="col-sm-12">
											<div className="form-group">
												...
												{errors.region && touched.region && (
													<span className="error-msg text-danger-ANL">{errors.region}</span>
												)}
											</div>
										</div>
									</div>
										...
										<div className="col-sm-12">
											<div className="form-group">
												...
												{errors.country && touched.country && (
													<span className="error-msg text-danger-ANL">{errors.country}</span>
												)}
											</div>
										</div>
									</div>
										...
										<div className="col-sm-12">
											<div className="form-group">
												...
												{errors.state && touched.state && (
													<span className="error-msg text-danger-ANL">{errors.state}</span>
												)}
											</div>
										</div>
									</div>
										...
										<div className="col-sm-12">
											<div className="form-group">
												...
												{errors.city && touched.city && (
													<span className="error-msg text-danger-ANL">{errors.city}</span>
												)}
											</div>
										</div>
									</div>
