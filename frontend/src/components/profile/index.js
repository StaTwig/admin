		...
		if (wareHouseResponse.status === 1 || wareHouseResponse.success) {
			...
			this.setState({
				...
				warehouseLocations: response.data.data.warehouses.filter(
					(i) => i.status === "ACTIVE" || i.status === "PENDING" || i.status === "NOTVERIFIED",
				),
                      ...
                      />
															...
															>
																<PopUpLocation
																	...
																	setWareHouseLocations={(v) =>
																		this.setState({
																			warehouseLocations: [...this.state.warehouseLocations, v],
																		})
																	}
																/>
															</Modal>
									...
									<div>
										<div className="col">
											...
											<div className="row row-list">
												<img src={Mail} width="20" height="20" className="mr-3" alt="Address" />
															...
															<div className="custom-card p-3">
																...
																<div className="card-body">
																	...
																	<div className="full-address">
																		{this.state.warehouseLocations[id].warehouseAddress
																			.firstLine ? (
																			<span>
																				{
																					this.state.warehouseLocations[id].warehouseAddress
							...
							{!editMode ? (
								...
								>
									<img src={PenWhite} width="15" height="15" className="mr-2 mb-1" alt="Edit" />
									<span>{t("edit")}</span>
								</button>
							) : (
								<div
								...
								>
									<button className="buttonS btn btn-outline-primary mr-2" onClick={this.onCancel}>
										<span>{t("cancel")}</span>
									</button>
									<button
