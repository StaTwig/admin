...
import styles from '../potable/style.scss';
        ...
        <div className="overflow">
          {props.shipments.map((shipment, index) => (
            <div className="rTableRow" key={index}>
              ...
              <div className="rTableCell"><div class="status" target={shipment.status}>{shipment.status}</div></div>
 <div className="rTableCell"><button class="button" onClick={() =>
                     {
