          ...
          <div className="">
            ...
            return (
              <div className="rTableRow pt-2 pb-2" key={index}>
                ...
                <div className="rTableCell" style={{left:"145px"}}>
