...
import { newDemoRequest, validateRequest, verifyEmailAndPhoneNo } from "../../../actions/userActions";
			...
			<form onSubmit={handleSubmit(requestDemo)}>
				<article className="vl-input-group">
					...
					<div className="input-full-space">
						...
						{errors.phone &&
							(errors.phone && (
								<span className="error-msg text-dangerS" style={{ fontSize: "12px" }}>
						...
						<Controller
							...
							render={({ field }) => (
								<TextField
									...
									helperText={Boolean(errors.designation) && "Designation is required!"}
								/>
							)}
						/>
					</div>
						...
						<Controller
							...
							render={({ field }) => (
								<TextField
									...
									helperText={
										Boolean(errors.softwareApplication) && "Software Application is required!"
									}
								/>
							)}
						/>
						...
						<Controller
							...
							render={({ field }) => (
								<TextField
									...
									helperText={
										Boolean(errors.numberOfEmployees) && "Number of employees is required!"
									}
								/>
							)}
						/>
					...
					<section className="call-by-action">
						<button className="vl-btn vl-btn-md vl-btn-full vl-btn-primary">Submit</button>
					</section>
				</article>
			</form>
		</section>
