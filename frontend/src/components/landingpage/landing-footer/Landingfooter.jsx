...
export default function Landingfooter({contactRef}) {
  return (
		<>
				...
				<div className="vl-page-container">
					<div className="footer-four-column-layout">
						<div className="powered-column">
							...
							<div className="footer-content-area">
								<figure className="company-logo">
									<img src={Statwig} alt="statwig" className="company-logo-image" />
								</figure>
								<figure className="mobile-app-stores">
									<a
										...
										target="_blank"
									>
										<img src={appstore} alt="store" className="mobile-store-icons" />
									</a>
									<a
										href="https://play.google.com/store/apps/details?id=com.thevaccineledger"
										target="_blank"
									>
										<img src={googlestore} alt="store" className="mobile-store-icons" />
									</a>
								</figure>
							</div>
						</div>
						<div className="address-column">
							...
							<div className="footer-content-area">
								...
								<div className="address-card">
									...
									<article className="full-address">
										<p className="vl-body f-400 vl-grey-sm">3 Fraser Street #05-25,</p>
										<p className="vl-body f-400 vl-grey-sm">Duo Tower, Singapore - 189352</p>
									</article>
								</div>
							</div>
						</div>
						<div className="contact-column">
							...
							<div className="footer-content-area">
								<section className="contact-group">
									<article className="contact-card">
										...
										<p className="vl-body f-400 vl-grey-sm">(+91) 939 059 0319</p>
									</article>
									<article className="contact-card">
										<div className="contact-heading">
							...
							<h1 className="vl-subtitle f-500 vl-black top-space">Help Center</h1>
							<div className="footer-content-area">
								<section className="contact-group">
			...
			<section className="copy-section bg-blue">
				<div className="vl-page-container">
					<article className="copy-rights ">
						<p className="vl-body f-400"> © 2022 StaTwig. All rights reserved.</p>
					</article>
				</div>
			</section>
		</>
