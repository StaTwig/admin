...
const updateStatus = async () => {
    const data = {shipmentId, firstName, organisationName, organisationLocation, updateStatusLocation,alerttrue,alertfalse,comments };
...
<div className="panel commonpanle">
      <h6 className="poheads potext mt-3 mb-3">Account Holder Details</h6>
              <div className="form-group">
              ...
              <div className="form-group">
                <label className="mb-1 text-secondary">Organisation Name*</label>
                <input
                  type="text"
                  className="form-control"
              ...
              <div className="form-group">
                <label className="mb-1 text-secondary">Organisation Location*</label>
                <input
                  type="text"
                  className="form-control"
              ...
              <div className="form-group">
                <label className="mb-1 text-secondary">Update Status Location*</label>
                <input
                  type="text"
                  className="form-control"
  ...
  <h6 className="poheads potext mt-3 mb-3">Comment*</h6>
            ...
            <div className="col ml-5">
              ...
              <div className="d-flex flex-column upload">
               ...
               <label>Drag and drop files here <input type='file' class="select" onChange={setFile}/> </label>
               <div>or</div>
               <label class="btn-primary btn browse">Browse Files<input type='file' class="select" onChange={setFile}/> </label>
              </div>
            </div>
           <div></div>
          </div>
          ...
          <div className="d-flex flex-row justify-content-between">
            ...
            <div>
              {' '}
              <button className="btn btn-outline-primary mr-4" onClick={() => props.history.push('/tracing')}>CANCEL</button>
              <button className="btn btn-orange fontSize20 font-bold mr-4 product" onClick={updateStatus}>
