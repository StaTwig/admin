          ...
          <div className="row">
            <div className="col-md-6 col-sm-12 align-text-center my-auto">
              ...
              <p>
                ...
                expired products in the production using Blockchain technology
                and IoT.
                <br />
                We are focused towards creating an efficient food and Vaccine
                distribution Supply chain.This helps in preventing failures of
                distribution, predicting the resources.Through our platform, we
                connect all stakeholders via tamper-proof, open ledgers using
                our platform VaccineLedger
              </p>
            </div>
        ...
        <div className="container d-flex flex-row justify-content-between">
          ...
          <div className="row h-100 align-items-center">
            <div className="d-flex flex-column">
              ...
              <p>
                Download the VaccineLedger Mobile app for Android, iOS from
                below{" "}
              </p>
              <div className="mt-1">
                <a
