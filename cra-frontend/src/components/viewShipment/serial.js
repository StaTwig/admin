...
<div className="panel d-flex flex-column">
   <div className="d-flex flex-column">
     <div className="row mb-4">
       ...
       <div className="font-weight-bold">{props.tracingShipment.serialNumber}</div>{' '}
       </div>
       </div>
       <div className="row mb-4">
       ...
       <div className="wallet">Wallet Address :{props.tracingShipment.receiver}</div>{' '}
       </div>
       </div>
       ...
       <div className="col">
       <div>{props.tracingShipment.supplierLocation}</div>
       <div className="wallet">{props.tracingShipment.estimateDeliveryDate}</div>
       </div>
       <div className="col">
       <div>Dispatched from {props.tracingShipment.manufacturerName} Warehouse</div>
       <div className="wallet">Wallet Address :{props.tracingShipment.receiver}</div>{' '}
       </div>
       </div>
