          ...
          <div className='col'>
            ...
            <div className='col panel chain chainpanle'>
              <div className='row justify-content-between'>
                <div className='col'>
                  <div>
                    <strong>{`Purchase Order ${custody.poStatus}`}</strong>
                  </div>
                  <div>
                    By: <strong>{custody.supplier.organisation.name}</strong>
                  </div>
                </div>
                <div className='col'>
                  <div className='emp'></div>
                  <div>
                    Unicef Po ID : <strong>{custody.externalId}</strong>
                  </div>
                  <div></div>
                </div>
              ...
              {op === index ? (
                <div className='d-flex flex-row'>
                  <button
                    className='btn btn-yellow dir mt-4'
                    onClick={() => props.setOpenPurchase(true)}
                  >
                    View Purchase Order
                  </button>
                </div>
