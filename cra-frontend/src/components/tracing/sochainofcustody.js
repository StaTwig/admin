            ...
            <div className='col'>
              ...
              <div className='col panel chain chainpanle'>
                <div className='row justify-content-between'>
                  <div className='col'>
                    <div>
                      <strong>{`Shippment ${custody.status}`}</strong>
                    </div>
                    <div className='row'>
                      <div className='col'>
                        ...
                        <div>
                          Organisation Name :{" "}
                          <strong>{shipmentData.supplier.org.name}</strong>
                        </div>
                        <div className='mb-1'>
                    ...
                    <div className='row'>
                      <div className='col'>
                        ...
                        <div>
                          Organisation Name :{" "}
                          <strong>{shipmentData.receiver.org.name}</strong>
                        </div>
                        <div className='mb-1'>
                          Organisation Location:{" "}
                          <strong>
                  ...
                  <div className='col'>
                    ...
                    <div>
                      Shipping Order ID : <strong>{shipmentData.id}</strong>
                    </div>
                    <div></div>
                  </div>
                ...
                {op === index && index !== 0 ? (
                  <div className='d-flex flex-row'>
                    ...
                    <div>
                      Comment : <strong>{custody.updateComment}</strong>
                    </div>
                  </div>
                ) : null}
              </div>
          ...
          <div className='row mb-3'>
            ...
            <div className='col'>
              ...
              <div className='col panel chain chainpanle'>
                <div className='row justify-content-between'>
                  <div className='col'>
                    ...
                    <div className='mb-1'>
                      Warehouse ID :{" "}
                      <strong>
                        {shipmentData.supplier.warehouse.organisationId}
                      </strong>
                    </div>
                    <div className='mb-1'>
                      Warehouse Location:{" "}
                ...
                {op === index && index !== 0 ? (
                  <div className='arrow float-right' onClick={() => setOp("")}>
