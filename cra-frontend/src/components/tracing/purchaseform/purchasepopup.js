...
const PurchasePopUp = (props) => {
  let totalQuantity = 0;
  props.shipments.poDetails[0].products.forEach(
  ...
  return (
    <div className='PO'>
      ...
      <div className='row'>
        ...
        <div className='col'>
          <div className='input-group text-primary font-weight-bold mb-3'>
            Customer Details
          </div>
          <div className='input-group'>
            <label className='reference custom2'>Organisation ID : </label>
          ...
          <div className='input-group'>
            ...
            <p>
              {
                props.shipments.poDetails[0].customer.shippingAddress
                  .shippingAddressId
              }
            </p>
          </div>
