  ...
  return (
      <div className="row text-center text-dark col ml-5">
        <div className="col tcell p-2 ">
          <div className="row ml-1 mb-3 p-0">
            <div className="col tcell">
              <div className="mr-5" style={{color:"black",fontSize:"14px",position:"relative", bottom:"8px",left:"-11px"}}>
                {prod.type}
              </div>
            </div>
          </div>
        ...
        <div className="col pl-5 tcell">  {/* pl-4 text-center justify-content-center */}
              <div className="" style={{color:"black",fontSize:"14px",position:"relative",left:"13px"}} >
        ...
        <div className="mr-4" style={{color:"black",fontSize:"14px",position:"relative",left:"13px"}}>
        {prod.manufacturer}
        </div>
        </div>
        <div className="col pl-5 ml-3 tcell">
          <div className="mr-4" style={{color:"black",fontSize:"14px",position:"relative",left:"5px"}}>
