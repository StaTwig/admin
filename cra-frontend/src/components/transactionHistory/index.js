...
const TransactionHistory = (props) => {
  return (
    <div className="transactionHistory">
      ...
      <h4>Payment Successful ! <img src={BlueTrans} height="40" width="40" className="ml-3"/></h4>
      <div className ="row mt-4">
        ...
        <div className="card trans">
          ...
          <div className="d-flex flex-row justify-content-between mt-4">
              <div className="recive">Received <span className="recive">2,50,000</span></div>
        ...
        <div className="card trans">
          ...
          <div className="mt-4">
              Purchase Order ID <span className="font-weight-bold ml-5">PO12345</span>
          </div>
        ...
        <div className=" d-flex flex-row mr-4">
            ...
            <div className="mb-2 text-secondary">Organisation ID</div>
            <div className="mb-2 text-secondary">Delivery Location ID</div>
