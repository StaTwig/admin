            ...
            <div className="card">
              <div className="card-body">
                <div className="login-form mt-2">
                  ...
                  <div className="card-title mr-2 mb-0 mt-3"><h6 style={{color:"#0093E9",fontWeight:"600"}}>OR</h6></div>
                  ...
                  <div className="form-group mt-0 ml-3 p-1" style={{position:"relative", left:"-38px"}}>
