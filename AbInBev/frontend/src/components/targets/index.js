...
const Targets = (props) => {
    ...
    const onSave = () => {
        ...
        let arr = [];
        selectedArray.map((e) => arr.push({"depot": [e.value], "percentage": parseInt(displayDistricts[e.index].percentage)}))
            ...
            <div className="row">
              ...
              <div className="col-md-9 mainContainer pt-3 px-4">
                ...
                <div
                  ...
                  style={{
                    padding: `${
                      displayDistricts.length > 0 ? "2rem" : "unset"
                    }`,
                  }}
                >
                    ...
                    {displayDistricts.map((district, index) => (
                      <div style={{ marginBottom: "20px" }}>
                        {checkedAllDis ? (
                          ...
                          <input
                            id={"distict" + index}
                            onChange={(e) => selectCheckBox(e, district._id.depot, index)}
                            type="checkbox"
                            style={{ marginRight: "5px" }}
                        ...
                        <div className='setReturnTarget'>
                            <div style={{ marginBottom: "20px" }} >
                          <select value={`${district.percentage}`}
