  ...
  return (
    <div className="verifyPasswordScreen">
      <div className="align-center pb-5 pt-5">
        ...
        <span className="verifyTitleSubHeading">
          Please enter the Verification Code <br /> Sent to <b>"{email}"</b>
        </span>
      </div>
      <div className="login-form">
        ...
        {errorMessage ? (
          <h4 className="error-message text-danger pb-2">{errorMessage}</h4>
        ) : (
          ''
        )}

        <div>
          <p className="signUpDesc mt-1 mb-3 ">
            Didn’t get the code?{' '}
            <a
              href="#"
              onClick={() => {
          ...
          {resendMessage ? (
            <h4 className="text-primary pb-2">{resendMessage}</h4>
          ) : (
            ''
          )}
        </div>
        ...
        <div className="text-center mt-5">
          ...
          <p className="signUpDesc mt-3 mb-3 ">
