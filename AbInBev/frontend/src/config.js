...
export function config() {
  const confs = {
    ...
    ainbevtest: {
      ...
      getAllAnalytics: `${LOCAL_SERVER_URL_AANALYTICS}/advancedanalytics/api/analytics/getAllStats`,
      ...
      getOverviewStats: `${LOCAL_SERVER_URL_AANALYTICS}/advancedanalytics/api/analytics/getOverviewStats`,
      getSupplierPerfomance: `${LOCAL_SERVER_URL_AANALYTICS}/advancedanalytics/api/analytics/getSupplierPerfomance`,
    },
  };
