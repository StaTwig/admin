...
export function config() {
  const confs = {
    ainbevprod: {
      ...
      allStatsAnalticsUrl:`${ABINBEVPROD_SERVER_URL}/advancedanalytics/api/analytics/getAllStats`,
    },
    ainbevtest: {
      ...
      allStatsAnalticsUrl:`${ABINBEVTEST_SERVER_URL}/advancedanalytics/api/analytics/getAllStats`,
    },
  };
